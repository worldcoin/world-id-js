...
const SStatefulIcon = styled.div`
  background-color: ${(props: StatefulIconInterface) =>
    props.state === 'success' ? 'var(--primary)' : 'var(--bg-mid)'};
  border-radius: 50%;
  color: var(--primary);
  width: 72px;
  height: 72px;
  ...
  font-size: ${(props: StatefulIconInterface) => (props.state === 'success' ? '3em' : '1.4em')};
  margin-bottom: 32px;
  margin-top: 16px;
`
